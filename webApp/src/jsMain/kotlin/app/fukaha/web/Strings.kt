...
class Strings(
    ...
    companion object {
        val EN = Strings(
            ...
            themeLight = "Light",
            themeDark = "Dark",
            themeHoldSystem = "Hold for system theme",
        ...
        val AR = Strings(
            ...
            themeLight = "فاتح",
            themeDark = "داكن",
            themeHoldSystem = "اضغط مطولاً لاتباع سمة النظام",
        ...
        val JA = Strings(
            ...
            aboutBody = "Fukaha（فكها）は、SNS のリンクからトラッキング情報を取り除き、埋め込みに適したホストへ変換します。",
            version = "バージョン",
            githubTitle = "GitHub",
        ...
        val ZH_CN = Strings(
            ...
            aboutBody = "Fukaha（فكها）可清除社交链接中的跟踪参数，并将其改写为适合嵌入预览的主机。",
            version = "版本",
            githubTitle = "GitHub",
        ...
        val ES = Strings(
            ...
            themeLight = "Claro",
            themeDark = "Oscuro",
            themeHoldSystem = "Mantén pulsado para el tema del sistema",
            ...
            aboutBody = "Fukaha (فكها) elimina el seguimiento de los enlaces sociales y los reescribe con servidores compatibles con vistas previas.",
            version = "Versión",
            githubTitle = "GitHub",

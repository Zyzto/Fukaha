...
ويعمل فحص توفّر خدمات المعاينة هنا أيضاً، ويُشغَّل يدوياً من الإعدادات: يمنع CORS قراءة رد الموقع الآخر، لكنه لا يمنع معرفة ما إذا وصل رد أصلاً، فطلب `no-cors` ينجح مع أي رمز حالة ويفشل فقط عند خلل في الشبكة — وهو الحد نفسه الذي يفرّق به فحص أندرويد بين المتاح وغير المتاح. أما تتبّع الروابط المختصرة وتحميل الوسائط فيبقيان في التطبيق وحده، لأن تتبّع التحويل يعني قراءة رد لا يسمح المتصفح بقراءته.
